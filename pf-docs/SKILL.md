...
If today.md is found, read it to understand the user's current focus, active goals, and any blockers for today. Use this to orient your work — not to override the task, but to connect the documentation to the user's broader context.
