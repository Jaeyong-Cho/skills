...
If `source-of-truth/` exists in the project root, read all files in it first.
...
A concrete plan with: goal, architecture decision, build sequence, and top risks. Offer to write it to `source-of-truth/` via `/to-sot`.
