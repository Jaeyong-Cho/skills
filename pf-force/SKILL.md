...
Run `grill-me` skill. Starting context: the user's force — their idea, observation, or issue. Cover at minimum:
...
- **End-to-end check** — any goal created or changed must have concrete input → observable output
