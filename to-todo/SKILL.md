...
## Add
1. Read `.context/TODO.md` (create it with just a `# TODO` header if missing — `mkdir -p .context` first).
...
## List
Read `.context/TODO.md` and report the checklist titles and their checked state. If the file doesn't exist, say the todo list is empty.
