...
e.g. Auth tokens are validated on every request by hitting the DB, capping throughput at 200 req/s during peak traffic. Product wants 1000 req/s sustained.
