...
The parent assigns exactly one development stage and one or more personas in the task. Review only that stage through those personas. Do not substitute generic code review, redesign unrelated parts, or invent future requirements.
