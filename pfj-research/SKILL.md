...
name: pfj-research
description: |
  Capture and sharpen research from an experiment, observation, or phenomenon — grills the user to extract what they observed and challenge their assumptions, then writes a rich HTML research note to the global journal.
...
Grill to extract what user observed and challenge their reasoning. Write HTML research note to global journal.
...
Footer: `Generated by pfj-research · date · slug`
