...
- Workflow — phase-by-phase mapping of the cycle onto the existing skills (`@skills/to-context`/`@skills/experiment`, `dev-checklist.md`/`story-checklist.md`, `@skills/to-plan`, `@skills/do-plan`, `@skills/boy-scout`), and any goal-specific deviation from that default order
