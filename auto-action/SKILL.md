...
After all steps are done, report what changed for each step in order. Write any domain truths or key decisions discovered during execution to `.context/wiki/` via `/to-wiki`.
