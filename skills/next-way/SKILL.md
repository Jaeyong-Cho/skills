---
name: next-way
description: Find the next actionable Wayfinder way by checking recorded in-progress markers and dependencies, then explain its purpose, context, and next steps. Invoke as /next-way.
