...
- New simple and representative testcase with built program integration test. (one concrete example per scenario bullet above — real names/numbers, not "a user" / "some data")
