...
**MUST RUN** `@skills/grill-me` covering every point in `../references/story-checklist.md` to build the Story. Phrase every question in plain, ELI5 language — no jargon, no unexplained terms.
