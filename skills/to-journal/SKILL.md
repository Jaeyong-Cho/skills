...
4. **Write it ELI5.** No jargon, no file paths unless essential, no internal tool names. Explain it the way you'd explain it to someone with zero context on this codebase. If a sentence needs a technical term to make sense, it's not ELI5 yet — simplify further.
