...
**MUST DISPATCH** sub-agent (gpt-5.6-luna model thinking xhigh for pi or copilot / claude-haiku-4.5 thinking high for claude-code) if uncertainty high can resolve with small experiment.
