---
name: to-context
description: Write up this session as a context document — objective, background, key facts, current state — so a fresh session can resume it cold. Filed alongside @skills/explore and @skills/experiment output. Invoke as /to-context.
