...
3. **MUST Record it.** Create a directory for this question, `explores/{slug}/` (kebab-case slug of the question), and write the results and evidence there in `../references/document-style.md` style.

Completion criterion: the question has a written answer with evidence, filed under the context directory.
