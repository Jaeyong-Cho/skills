...
7. **Draft the plan**, covering:
   ...
   - Commit — draft the commit message now (why this change, not a file list); `@skills/do-plan` runs the real `git commit` with it once every action item is checked and every acceptance criterion passes.
