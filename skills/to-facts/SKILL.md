---
name: to-facts
description: Capture the session's verified facts, decisions, and current state in a reusable context file. Use when the user wants session facts recorded, a cold-start handoff, or factual context for a fresh agent. Invoke as /to-facts.
---
