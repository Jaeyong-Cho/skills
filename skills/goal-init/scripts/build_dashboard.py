...
.stat { flex: 1 1 140px; border: 1px solid var(--line); border-radius: 4px; background: var(--bg); padding: 0.9rem 1.1rem; }
.stat .n { font-family: var(--mono); font-weight: 600; font-size: 1.5rem; line-height: 1.2; }
