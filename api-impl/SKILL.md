...
Read [deep-modules](references/deep-modules.md), [layers](references/layers.md), [tdd](references/tdd.md), [tdd-tests](references/tdd-tests.md), [tdd-mocking](references/tdd-mocking.md), and [tdd-refactoring](references/tdd-refactoring.md) before starting.
