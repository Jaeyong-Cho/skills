...
| `/l1-implement` | — | Implement one L1 orchestration function directly from a plain-language use-case description, per `abstraction-levels.md`: decompose into L2/L3, reuse before creating, stub only what's underspecified, integration-test it — no plan file, lighter than `/dev-grill-me` |
