...
| `/req-ood-tdd` | — | Orchestrate prototype → vertical requirements → OOD → one TDD plan per slice → implementation → review → commit → merge → release |
