...
| `/to-way` | `ways/{nn}-{slug}/0-goal.md` and nested work-package files | Preserve a Wayfinder task plan, including Why/What/How details, dependency links, and execution guidance; keep small tasks inline, with file numbers indicating presentation order only |
