...
| `/self-action` | code changes + tests | Generate tests, scaffold function signatures and interfaces (you design contracts), write complete implementation logic (edge cases, assertions, validation). |
