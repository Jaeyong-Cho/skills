...
| `/to-paper` | `{slug}-research-paper/{index.html,manifest.json,assets/*.svg}` | Write a short HTML research paper — numbered Introduction/Background/Methodology/Results/Conclusion, at least 3 diagram-design-themed SVG figures — from a manifest.json, linted for writing-quality rules and built with a script; never hand-edit the HTML |
