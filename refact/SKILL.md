...
5. **Apply** — make the single structural change; do not refactor anything else in the same pass
6. **Verify** — confirm the split boundary is clean: no circular deps, no leaked internals
